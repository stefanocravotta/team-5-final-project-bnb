<template>
    <div class="">
        <div class="container-fluid">
            <div class="d-flex mb-imgSection">
                <img
...
// container delle info
    .mb-containerInfo{
        margin: 0;
        .mb-infoHome{
            border: 1px solid rgb(255, 103, 43);
            border-bottom: 2px solid rgb(255, 103, 43);
            border-top: 2px solid rgb(255, 103, 43);
        ...
        @media screen and (max-width: 992px) {
            .mb-infoHome{
                border-bottom: 1px solid rgb(255, 103, 43);
                border-top: 1px solid rgb(255, 103, 43);
            }
            .mb-infoHome:first-of-type{
                border-top:  2px solid rgb(255, 103, 43);
                border-left:  2px solid rgb(255, 103, 43);
            }
            .mb-infoHome:last-of-type{
                border-bottom:  2px solid rgb(255, 103, 43);
                border-right:  2px solid rgb(255, 103, 43);
            }
        }
    }
